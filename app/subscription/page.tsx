  ...
  return (
    <div className="flex min-h-screen text-gray-900">
      ...
      <main className="flex-1 p-8">
        <h1 className="text-2xl text-yellow-500 font-bold mb-8">Subscription plan</h1>

        <div className="grid md:grid-cols-2 gap-6 rounded-lg p-6 bg-black border-yellow-500 text-yellow-400 font-semibold backdrop-blur-md transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(255,215,0,0.4)]">
          {/* CURRENT PLAN */}
          <div className="border-r border-gray-100 pr-6">
            <p className="text-xs text-gray-50 font-semibold uppercase tracking-wider mb-4">
              Current Plan
            </p>
            ...
            <button className="text-sm text-yellow-600 underline hover:text-white-700">
          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-6">
              <button className="flex items-center justify-center   px-4 py-2 rounded-full border border-yellow-500 text-yellow-400 font-semibold bg-yellow-500/10 backdrop-blur-md hover:bg-yellow-500/20 hover:text-yellow-300 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(255,215,0,0.4)]">
                Add an Additional Website
              </button>
              <button className="bg-white text-black rounded-lg px-4 py-2 text-sm hover:bg-purple-700">
                Upgrade now
              </button>
            </div>
          </div>
        ...
        <div className="mt-10 border-t border-gray-100 pt-6 flex items-center justify-between">
          ...
          <button className="border border-gray-300 text-gray-800 rounded-lg px-4 py-2 text-sm bg-white  hover:bg-white">
            Cancel Subscription
          </button>
        </div>
      </main>
